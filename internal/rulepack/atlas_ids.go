// Code generated from MITRE ATLAS data (dist/ATLAS.yaml, version 5.6.0); DO NOT EDIT.
// Regenerate: scripts/gen-atlas-ids.sh

package rulepack

// ATLASVersion is the ATLAS release the technique table was generated from.
const ATLASVersion = "5.6.0"

// atlasTechniques lists every technique and sub-technique ID in that release.
